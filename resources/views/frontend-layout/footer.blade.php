            ...
            <div class="col-lg-3 col-md-6 col-sm-6">
                <div class="footer__about">
                    ...
                    <ul>
                        ...
                        <li>Phone: {{setWebsite('phone_no')}}</li>
                        <li>Email: {{setWebsite('website_email')}}</li>
                    </ul>
                </div>
            </div>
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="footer__copyright">
                    ...
                    <div class="footer__copyright__payment"><img src="{{asset('assets/front/img/payment-item.png')}}" alt="IMG">
                    </div>
                </div>
            </div>
        </div>
